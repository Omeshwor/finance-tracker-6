...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-5.1.3".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<octokit>.freeze, ["~> 4.18", ">= 4.18.0"])
      ...
      s.add_dependency(%q<octokit>.freeze, ["~> 4.18", ">= 4.18.0"])
